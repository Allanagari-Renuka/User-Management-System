...
export function ProfileForm({ profile, userId }: ProfileFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {errors.submit && <p className="text-sm text-destructive bg-destructive/10 p-3 rounded-md">{errors.submit}</p>}
      {successMessage && <p className="text-sm text-emerald-600 bg-emerald-50 p-3 rounded-md">{successMessage}</p>}
